...
@student_views.route('/users/add-student', methods=['POST'])
def add_student_route():
    try:
        ...
        success, message = add_student(data.get('studentID'), data.get('studentName'), data.get('degree'), data.get('year'), data.get('karma'))
...
@student_views.route('/users/get-student-by-id/<int:sid>', methods=['GET'])
...
@student_views.route('/users/get-students-by-name', methods=['GET'])
...
@student_views.route('/users/get-all-students', methods=['GET'])
...
@student_views.route('/users/update-student/<int:sid>', methods=['POST'])
...
@student_views.route('/users/delete-student/<int:sid>', methods=['POST'])
...
@student_views.route('/users/update-karma/<int:sid>', methods=['POST'])
